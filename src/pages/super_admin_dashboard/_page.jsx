...
import { countries, taxType } from "../../core/data";
      ...
      <div className="flex">
        <form id="tax-form" className="w-full" onSubmit={handleTaxSubmit}>
          ...
          <div className="grid grid-cols-3 gap-6 mt-8">
            ...
            <div className="field">
              <label className="text-sm label">Minimum Chargeable Income</label>
              <div className="control">
                <input
                  required
                  className="bg-gray-50 mr-2 border outline-0 border-gray-300 text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5 "
          ...
          <div className="grid grid-cols-3 gap-6 mt-8">
            <div className="field">
              <label className="text-sm label ">Select Effective From</label>
              <Flatpickr
            ...
            <div className="field">
              <label className="text-sm label ">Select Effective To</label>
              <Flatpickr
                className="bg-gray-50 mr-2 cursor-pointer border outline-0 border-gray-300 text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5 "
            ...
            <div className="mt-8 ml-6 field">
              <label className="text-sm label">Add Status Message</label>
              <input
            ...
            <div className="w-full mr-2">
              <label className="text-sm label">Select Distributed</label>
              <div className="flex w-full row mobile:w-full">
                <Select
                  className="w-full"
