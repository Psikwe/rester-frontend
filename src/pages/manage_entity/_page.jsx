          ...
          <div>
            ...
            <div className="flex mx-2 mt-6">
              <button
                ...
                className="w-full px-4 mr-2 text-xs text-white rounded-full mt-9 primary mobile:w-full"
              >
                Cancel
              </button>
              <button
                onClick={confirmDelete}
                className="w-full px-4 py-2 text-xs text-white bg-red-500 rounded-full mt-9 mobile:w-full"
              >
                Delete
              </button>
            </div>
